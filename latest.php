...
! function(t) {
    ...
    i = function() {
        ...
        function d(e, n, r) {
            ...
            function m() {
                if (!--y)
                    for (var t in u[c] = 1, s && s(), f) l(t.split("|"), g) && !p(f[t], g) && (f[t] = [])
            }
    ...
    (function(e, n) {
        ...
        r = function() {
            ...
            h ? b = function() {
                return e.nextTick(v)
            } : f ? (g = 0, m = new f(v), w = document.createTextNode(""), m.observe(w, {
                characterData: !0
            }), b = function() {
                w.data = g = ++g % 2
            ...
            function I(t, e) {
                ...
                else if (o = typeof(r = e), null === r || "object" !== o && "function" !== o) N(t, e);
                else {
                    var n = void 0;
                    try {
                        n = e.then
            ...
            var R = function() {
                    ...
                    return t.prototype._enumerate = function(t) {
                        ...
                        if (r === _) {
                            ...
                            if (o === O && t._state !== C) this._settledAt(t._state, e, t._result);
    ...
    var r, o, i = n(0),
        ...
        a = function() {
            ...
            return t.prototype.init = function() {
                ...
                var e = t.type,
                    n = this.observers.getValuesAtKey(e);
                if (n)
    ...
    var y, g = function(t, e) {
            this.type = r.CONNECT, this.payload = {
                applicationKey: t,
                requestedVersion: e
            }
        },
